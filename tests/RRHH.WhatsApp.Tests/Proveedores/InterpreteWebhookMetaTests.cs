...
public class InterpreteWebhookMetaTests
{
    ...
    {
        var mensaje = Assert.Single(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.MensajeDeTexto));
    ...
    public void Extrae_el_id_del_boton_pulsado()
    {
        ...
        var mensaje = Assert.Single(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.RespuestaDeBoton));
    ...
    {
        var mensaje = Assert.Single(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.RespuestaDeLista));
    ...
    public void Extrae_el_payload_de_una_respuesta_rapida_de_plantilla()
    {
        ...
        var mensaje = Assert.Single(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.BotonDePlantilla));
    ...
    {
        var mensaje = Assert.Single(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.Adjunto));
    ...
    {
        var mensajes = InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.DosMensajes);
    ...
    public void Los_acuses_de_entrega_van_por_separado_de_los_mensajes()
    {
        ...
        Assert.Empty(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.AcusesDeEntrega));

        var acuses = InterpreteWebhookMeta.Estados(PayloadsDePrueba.AcusesDeEntrega);
    ...
    {
        Assert.Empty(InterpreteWebhookMeta.Mensajes(PayloadsDePrueba.SinMensajes));
        Assert.Empty(InterpreteWebhookMeta.Estados(PayloadsDePrueba.SinMensajes));
    }
    ...
    public void Un_cuerpo_ilegible_no_revienta_el_webhook()
    {
        ...
        Assert.Empty(InterpreteWebhookMeta.Mensajes("{ esto no es json valido"));
        Assert.Empty(InterpreteWebhookMeta.Mensajes(""));
    }
